...
const Dashboard: NextPage = () => {
  ...
  return (<>
      ...
      { address !== undefined && (<PayerDashboardLayout >
          <br></br>
          <br></br>
          <br></br>
          <SimpleGrid columns={{ base: 3, md: 3, xl: 3 }} gap='20px' mb='20px'>
            <PayerWalletBanner address={intmaxWalletAddress} assetBalance={formatedBalance} assetSymbol={assetSymbol} assetIconImg={assetSymbolImage} />
            <PayerPlanBanner bgImagePath={payerPlanBgImagePaht} serviceName={serviceName} planImagePath={planImagePaht} startDate={startDate} planTokenSymbol={planTokenSymbol} symbolName={symbolName} />
