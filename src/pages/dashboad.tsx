...
const Dashboad: NextPage = () => {
	...
	const [tableDataComplexMap,setTableDataComplexMap] = useState(
		tableDataComplexs.map((output) => {
			return (
				<ComplexTable title={output.title} tableData={output.tableDataComplex} />
			);
		})
	)
	...
	useEffect(() => {
		setTableDataComplexMap(tableDataComplexs.map((output) => {
			return (
				<ComplexTable title={output.title} tableData={output.tableDataComplex} />
			);
		}))
	...
	useEffect(() => {
		setWeeklyReport(<WeeklyRevenue barChartDataConsumption={barChartDataConsumption} barChartOptionsConsumption={barChartOptionsConsumption} />)
	},[])
