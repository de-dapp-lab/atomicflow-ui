    ...
    return (
        <Box background="white" w='100%' p={4} color='white' borderRadius='30px'>
            ...
            <Text color="gray" fontSize="16px" >
                The address of the deposit destination. Deposits and withdrawals can be made while subscriptions are running
            </Text>
            ...
            <Box background="white" p={4} mt={4} borderRadius='10px' boxShadow="md" >
                <Flex>
                    <Image boxSize='80px' width={80} height={80} src={props.assetIconImg} alt={props.assetSymbol} />
                    <Box p={4}>
                        <Text color="gray" fontSize="16px" >
