  ...
  return (
    <Box background="white" w="100%" p={4} color="white" borderRadius="30px">
      <Flex justifyContent="space-between">
        ...
        <Button background="#4318FF" p={4} onClick={onclickCreate}>
          Create
        </Button>
      </Flex>
      <Text color="gray" fontSize="16px">
        First, let`&apos;s create a default plan. After creating a plan, you can
        customize it!
      </Text>
      <Box background="white" p={4} mt={4} borderRadius="10px" boxShadow="md">
        <Flex>
          <Image objectFit="cover" src="/img/basic.png" />
          <Box p={4}>
      ...
      <Box background="white" p={4} mt={4} borderRadius="10px" boxShadow="md">
        <Flex>
          <Image objectFit="cover" src="/img/pro.png" />
          <Box p={4}>
            <Text color="#2B3674" fontSize="16px">
              Pro Plan
            </Text>
      ...
      <Box background="white" p={4} mt={4} borderRadius="10px" boxShadow="md">
        <Flex>
          <Image objectFit="cover" src="/img/enterprise.png" />
          <Box p={4}>
            <Text color="#2B3674" fontSize="16px">
              Enterprise Plan
            </Text>
