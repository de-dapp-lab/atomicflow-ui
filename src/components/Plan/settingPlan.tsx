    ...
    <>
      ...
      >
        ...
        <Flex>
          ...
          <Box>
            <Flex p={4}>
              <Switch pr={4} size="sm" onChange={onchangeTrial} />
              <Text color={"black"}>Free trial</Text>
            </Flex>
            <Flex p={4}>
              <Switch pr={4} size="sm" onChange={onchangeSales} />
              <Text color={"black"}>Contacts Sales</Text>
            </Flex>
            <Flex p={4}>
              <Switch pr={4} size="sm" onChange={onchangePopular} />
              <Text color={"black"}>Display as most popular</Text>
            </Flex>
            <Flex p={4}>
              <Switch pr={4} size="sm" onChange={onchangeCustom} />
