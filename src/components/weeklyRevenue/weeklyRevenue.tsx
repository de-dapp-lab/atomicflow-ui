...
export default function WeeklyRevenue(props: { barChartDataConsumption:any,barChartOptionsConsumption:any }) {
	const { barChartDataConsumption,barChartOptionsConsumption } = props;
    const rest: any = [];
